# -*- coding: utf-8 -*-
"""Bryan Cliff - 232_Matriz_m.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1RAVAMngSv-9aPXFrMg5WNLydhU23SbD1
"""
...
for linha in range(2):
    vet_linha = []
    for coluna in range(2):
        vet_linha.append(float(input(f"Digite o salario aqui: ")))
        contador = contador + 1
        print(f"O {contador}ª salario está na linha {linha} e coluna {coluna}")
    matriz.append(vet_linha)
...
for linha in range(len(matriz)):
    for coluna in range(len(matriz[0])):
        soma_salarios = soma_salarios + matriz[linha][coluna]
print(f"A soma de todos os salarios é {soma_salarios}")
...
for linha in range (len(matriz)):
    for coluna in range (len(matriz[0])):
        if matriz[linha][coluna] < 23:
            print(f'Os valores menores que 23 reais estão na linha {linha} e o valor da coluna é {coluna}')
...
for linha in range(w):
    ...
    for coluna in range(p):
        ...
        if numero == 0:                                                                             # W significa linhas
            zeros = zeros + 1                                                                       # P significa colunas
...
for linha in range(len(matriz)):#qtde de linhas
    for coluna in range(len(matriz[0])):# qtde de colunas
        if linha == coluna: #diagonal principal
            print(f"Valor {matriz[linha][coluna]} linha {linha}, coluna {coluna}")
        if linha < coluna: # soma dos elemento acima da diagonal princiapl
